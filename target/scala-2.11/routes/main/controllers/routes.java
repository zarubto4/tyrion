...
public class routes {
  ...
  public static final controllers.ReverseGridController GridController = new controllers.ReverseGridController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseGridController GridController = new controllers.javascript.ReverseGridController(RoutesPrefix.byNamePrefix());
