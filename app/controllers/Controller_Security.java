...
import play.mvc.*;
import utilities.IgnoreConverter;
...
public class Controller_Security extends Controller {
    ...
    // Kvůli swaggeru a bytecode enhancement a convertování modelů do jsonu
    @javax.inject.Inject
    public Controller_Security(MessagesApi messagesApi) {
