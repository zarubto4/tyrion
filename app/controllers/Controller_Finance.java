...
public class Controller_Finance extends Controller {
    ...
    public Result product_create(){
        try{
            ...
            logger.debug("Controller_Finance:: product_create: Creating new product");
            ...
            if(tariff.payment_mode_required) {
                ...
                logger.debug("Controller_Finance:: product_create: Payment mode Required");
            ...
            if(tariff.payment_method_required) {
                ...
                logger.debug("Controller_Finance:: product_create: Payment method Required");
            ...
            if(!tariff.payment_required) {
                logger.debug("Controller_Finance:: product_create:: Payment is not required!");
                return GlobalResult.created(Json.toJson(product));
            }

            logger.debug("Controller_Finance:: product_create:: Creating invoice");
            ...
            logger.debug("Controller_Finance:: product_create:: Saving invoice");
