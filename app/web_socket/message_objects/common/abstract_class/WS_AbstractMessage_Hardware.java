...
public abstract class WS_AbstractMessage_Hardware {
 ...
 /* LOGGER  -------------------------------------------------------------------------------------------------------------*/
    ...
    private static final Class_Logger terminal_logger = new Class_Logger(WS_AbstractMessage_Hardware.class);
 ...
 /* VALUE --------------------------------------------------------------------------------------------------------------*/
    ...
    @JsonIgnore @Transient public Model_Board get_hardware(){
        return Model_Board.get_byId(hardware_id);
    }
}