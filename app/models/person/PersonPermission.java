...
/* PERMISSION ----------------------------------------------------------------------------------------------------------*/
    ...
    @JsonProperty public Boolean edit_person_permission() {  return  SecurityController.getPerson().has_permission("PersonPermission_edit_person_permission");  }
    @JsonProperty public Boolean edit_permission()        {  return  SecurityController.getPerson().has_permission("PersonPermission_edit"); }
