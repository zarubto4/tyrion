...
/* JSON PROPERTY METHOD && VALUES --------------------------------------------------------------------------------------*/
    ...
    @JsonProperty @Transient @ApiModelProperty(required = true) public List<Swagger_Library_Short_Detail>       c_private_libraries(){ List<Swagger_Library_Short_Detail>   l = new ArrayList<>();    for( Model_Library m        : get_c_private_project_libraries_not_deleted()) l.add(m.get_short_library()); return l;}
