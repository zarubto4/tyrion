...
/* PERMISSION ----------------------------------------------------------------------------------------------------------*/
    ...
    @JsonProperty @Transient public boolean update_permission()  {  return  ( B_Program.find.where().where().eq("project.participants.person.id", SecurityController.getPerson().id ).where().eq("id", id).findRowCount() > 0) || SecurityController.getPerson().has_permission("B_Program_update");  }
    @JsonIgnore   @Transient public boolean read_permission()    {  return  ( B_Program.find.where().where().eq("project.participants.person.id", SecurityController.getPerson().id ).where().eq("id", id).findRowCount() > 0) || SecurityController.getPerson().has_permission("B_Program_read");   }
    @JsonProperty @Transient public boolean edit_permission()    {  return  ( B_Program.find.where().where().eq("project.participants.person.id", SecurityController.getPerson().id ).where().eq("id", id).findRowCount() > 0) || SecurityController.getPerson().has_permission("B_Program_edit");    }
    @JsonProperty @Transient public boolean delete_permission()  {  return  ( B_Program.find.where().where().eq("project.participants.person.id", SecurityController.getPerson().id ).where().eq("id", id).findRowCount() > 0) || SecurityController.getPerson().has_permission("B_Program_delete");  }
