    ...
    public static void setServerValues() throws Exception{
        ...
        switch (server_mode_string) {
            ...
            case "production" : {
                ...
                // Nastavení adresy, kde běží Grid APP
                grid_app_main_url                   = "https://" + Configuration.root().getString("Grid_App.production.mainUrl");
            ...
            case "stage" : {
                ...
                // Nastavení adresy, kde běží Grid APP
                grid_app_main_url                   = "https://" + Configuration.root().getString("Grid_App.stage.mainUrl");
