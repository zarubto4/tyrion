...
public class Utilities_Master_thread_updater {

    // Loger
    static play.Logger.ALogger logger = play.Logger.of("Loggy");

    private static Utilities_Master_thread_updater instance = null;
    protected Utilities_Master_thread_updater() {/** Exists only to defeat instantiation.*/}

    public static Utilities_Master_thread_updater getInstance() {
        if(instance == null) {instance = new Utilities_Master_thread_updater(); start_thread_box();}
        return instance;
    }
            ...
            while(true){
                try{
                    ...
                    if(!procedures.isEmpty()) {
                        ...
                        new Utilities_Master_thread_updater().actualization_update_procedure( procedures.get(0) );
