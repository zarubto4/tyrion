...
/* METHOD  -------------------------------------------------------------------------------------------------------------*/
    ...
    public static void startEchoUpdateThread() {
        terminal_logger.info("startEchoUpdateThread - starting");
    ...
    public static void addToQueue(WS_Message_Update_model_echo message) {
        ...
        terminal_logger.info("addToQueue - adding update to queue");
            ...
            while (true) {
                try {
                    ...
                    if (!update_messages.isEmpty()) {
                        ...
                        terminal_logger.trace("send_update_messages_thread - in que is " + update_messages.size());
                        ...
                        terminal_logger.debug("send_update_messages_thread - no notifications, thread is going to sleep");
                        sleep(500000000);
                    }
    ...
    private static void sendUpdate(WS_Message_Update_model_echo message) {
        try {
            ...
            terminal_logger.trace("sendUpdate - sending update");
