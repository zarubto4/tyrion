...
//            try {
//
//                CompletionStage<WSResponse> responsePromise = ws.url(Server.GoPay_api_url + "/payments/payment/" + invoice.getProduct().contact.gopay_id + "/create-recurrence")
//                        .setContentType("application/json")
//                        .addHeader("Accept", "application/json")
//                        .addHeader("Authorization", "Bearer " + local_token)
//                        .setRequestTimeout(Duration.ofSeconds(10))
...
//            try {
//
//                CompletionStage<WSResponse> responsePromise = ws.url(Server.GoPay_api_url + "/payments/payment/" + product.contact.gopay_id + "/void-recurrence")
//                        .setContentType("application/x-www-form-urlencoded")
//                        .addHeader("Accept", "application/json")
//                        .addHeader("Authorization", "Bearer " + local_token)
//                        .setMethod("POST")
...
//
//                product.archiveEvent("Terminate on demand payment", "GoPay on demand payment number: " + product.contact.gopay_id + " was terminated", null);
...
//            } else {
//
//                product.archiveEvent("Terminate on demand payment", "Failed to terminate GoPay on demand payment number: " + product.contact.gopay_id, null);
...
//        }
    ...
    /**
     * TODO we do longer upload credit
     *
...
//        }
        return internalServerError(new Exception("Not implemented"));
    }
