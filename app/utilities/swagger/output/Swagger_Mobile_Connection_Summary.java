...
public class Swagger_Mobile_Connection_Summary {
    ...
    @ApiModelProperty(required = true, readOnly = true, value = "Grid Program code in String")                                                            public UUID grid_project_id;
    @ApiModelProperty(required = true, readOnly = true, value = "Grid Program code in String")                                                            public UUID grid_program_id;
    @ApiModelProperty(required = true, readOnly = true, value = "Grid Program code in String")                                                            public UUID grid_program_version_id;
