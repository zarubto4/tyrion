...
public class Swagger_UpdatePlan_brief_for_homer_BinaryComponent {
    ...
    @JsonProperty public String program_name;                       // C_Program.name or Model_Bootloader.name
    @JsonProperty public String program_version_name;               // C_Program.versions[1].name  for Model_BootLoader.version_identificator
    ...
    @JsonProperty public Date time_stamp;

    // Only for Enum_Firmware_type .FIRMWARE or .BACKUP
    @JsonInclude(JsonInclude.Include.NON_NULL) @JsonProperty public String compilation_lib_version;            // Model_TypeOfBoard.supported_libraries.tag_name    (try to find Swagger_CompilationLibrary)
}
