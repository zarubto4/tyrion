...
@ApiModel(description = "Individual SingleLibrary List",
        value = "Single_Library_List")
public class Swagger_Single_Library_List {

/* Content--------------------------------------------------------------------------------------------------------------*/

    @ApiModelProperty(required = true, readOnly = true)
    public List<Model_SingleLibrary> content;
...
/* Set -----------------------------------------------------------------------------------------------------------------*/
    ...
    public Swagger_Single_Library_List(Query<Model_SingleLibrary> query , int page_number){
