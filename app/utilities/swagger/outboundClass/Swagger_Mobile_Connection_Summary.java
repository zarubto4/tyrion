...
public class Swagger_Mobile_Connection_Summary {
    ...
    @ApiModelProperty(required = true, readOnly = true, value = "WS adress -> replaces token in URL by verified token from the other APIs if its required by query") public String url;
    ...
    @ApiModelProperty(required = false, readOnly = true, value = "Generated Token used for public programs, use as standard verification token")        public String instance_id;
}
