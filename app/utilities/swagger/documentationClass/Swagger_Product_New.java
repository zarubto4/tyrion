...
public class Swagger_Product_New {
    ...
    @ApiModelProperty(required = false, value =  "Required: only in if payment_details_required is true  values =>[bank_transfer, credit_card]")
    ...
    @ApiModelProperty(required = false, value =  "Required: always" +
