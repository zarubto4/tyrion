...
create table model_version_object (
  ...
  constraint uq_model_version_object_type_of_ unique (type_of_board_id),
...
alter table model_blocko_block_version add constraint fk_model_blocko_block_version_14 foreign key (blocko_block_id) references model_blocko_block (id);
create index ix_model_blocko_block_version_14 on model_blocko_block_version (blocko_block_id);
alter table model_board add constraint fk_model_board_type_of_board_15 foreign key (type_of_board_id) references model_type_of_board (id);
create index ix_model_board_type_of_board_15 on model_board (type_of_board_id);
alter table model_board add constraint fk_model_board_project_16 foreign key (project_id) references model_project (id);
create index ix_model_board_project_16 on model_board (project_id);
alter table model_board add constraint fk_model_board_actual_c_progr_17 foreign key (actual_c_program_version_id) references model_version_object (id);
create index ix_model_board_actual_c_progr_17 on model_board (actual_c_program_version_id);
alter table model_board add constraint fk_model_board_actual_boot_lo_18 foreign key (actual_boot_loader_id) references model_boot_loader (id);
create index ix_model_board_actual_boot_lo_18 on model_board (actual_boot_loader_id);
alter table model_board add constraint fk_model_board_virtual_instan_19 foreign key (virtual_instance_under_project_blocko_instance_name) references model_homer_instance (blocko_instance_name);
create index ix_model_board_virtual_instan_19 on model_board (virtual_instance_under_project_blocko_instance_name);
...
alter table model_cprogram add constraint fk_model_cprogram_example_lib_26 foreign key (example_library_id) references model_version_object (id);
create index ix_model_cprogram_example_lib_26 on model_cprogram (example_library_id);
alter table model_cprogram_update_plan add constraint fk_model_cprogram_update_plan_27 foreign key (actualization_procedure_id) references model_actualization_procedure (id);
create index ix_model_cprogram_update_plan_27 on model_cprogram_update_plan (actualization_procedure_id);
alter table model_cprogram_update_plan add constraint fk_model_cprogram_update_plan_28 foreign key (board_id) references model_board (id);
create index ix_model_cprogram_update_plan_28 on model_cprogram_update_plan (board_id);
alter table model_cprogram_update_plan add constraint fk_model_cprogram_update_plan_29 foreign key (c_program_version_for_update_id) references model_version_object (id);
create index ix_model_cprogram_update_plan_29 on model_cprogram_update_plan (c_program_version_for_update_id);
alter table model_cprogram_update_plan add constraint fk_model_cprogram_update_plan_30 foreign key (bootloader_id) references model_boot_loader (id);
create index ix_model_cprogram_update_plan_30 on model_cprogram_update_plan (bootloader_id);
alter table model_cprogram_update_plan add constraint fk_model_cprogram_update_plan_31 foreign key (binary_file_id) references model_file_record (id);
create index ix_model_cprogram_update_plan_31 on model_cprogram_update_plan (binary_file_id);
alter table model_change_property_token add constraint fk_model_change_property_toke_32 foreign key (person_id) references model_person (id);
create index ix_model_change_property_toke_32 on model_change_property_token (person_id);
alter table model_file_record add constraint fk_model_file_record_boot_loa_33 foreign key (boot_loader_id) references model_boot_loader (id);
create index ix_model_file_record_boot_loa_33 on model_file_record (boot_loader_id);
alter table model_file_record add constraint fk_model_file_record_version__34 foreign key (version_object_id) references model_version_object (id);
create index ix_model_file_record_version__34 on model_file_record (version_object_id);
alter table model_floating_person_token add constraint fk_model_floating_person_toke_35 foreign key (person_id) references model_person (id);
create index ix_model_floating_person_toke_35 on model_floating_person_token (person_id);
alter table GeneralTariffExt add constraint fk_GeneralTariffExt_general_t_36 foreign key (general_tariff_included_id) references model_general_tariff (id);
create index ix_GeneralTariffExt_general_t_36 on GeneralTariffExt (general_tariff_included_id);
alter table GeneralTariffExt add constraint fk_GeneralTariffExt_general_t_37 foreign key (general_tariff_optional_id) references model_general_tariff (id);
create index ix_GeneralTariffExt_general_t_37 on GeneralTariffExt (general_tariff_optional_id);
alter table model_general_tariff_label add constraint fk_model_general_tariff_label_38 foreign key (general_tariff_id) references model_general_tariff (id);
create index ix_model_general_tariff_label_38 on model_general_tariff_label (general_tariff_id);
alter table model_general_tariff_label add constraint fk_model_general_tariff_label_39 foreign key (extensions_id) references GeneralTariffExt (id);
create index ix_model_general_tariff_label_39 on model_general_tariff_label (extensions_id);
alter table model_grid_terminal add constraint fk_model_grid_terminal_person_40 foreign key (person_id) references model_person (id);
create index ix_model_grid_terminal_person_40 on model_grid_terminal (person_id);
alter table model_grid_widget add constraint fk_model_grid_widget_author_41 foreign key (author_id) references model_person (id);
create index ix_model_grid_widget_author_41 on model_grid_widget (author_id);
alter table model_grid_widget add constraint fk_model_grid_widget_type_of__42 foreign key (type_of_widget_id) references model_type_of_widget (id);
...
create index ix_model_homer_instance_recor_46 on model_homer_instance_record (version_object_id);
alter table model_homer_instance_record add constraint fk_model_homer_instance_recor_47 foreign key (actual_running_instance_blocko_instance_name) references model_homer_instance (blocko_instance_name);
create index ix_model_homer_instance_recor_47 on model_homer_instance_record (actual_running_instance_blocko_instance_name);
alter table model_invitation add constraint fk_model_invitation_owner_48 foreign key (owner_id) references model_person (id);
create index ix_model_invitation_owner_48 on model_invitation (owner_id);
alter table model_invitation add constraint fk_model_invitation_project_49 foreign key (project_id) references model_project (id);
create index ix_model_invitation_project_49 on model_invitation (project_id);
alter table model_invoice add constraint fk_model_invoice_product_50 foreign key (product_id) references model_product (id);
create index ix_model_invoice_product_50 on model_invoice (product_id);
alter table model_invoice_item add constraint fk_model_invoice_item_invoice_51 foreign key (invoice_id) references model_invoice (id);
create index ix_model_invoice_item_invoice_51 on model_invoice_item (invoice_id);
...
alter table model_product add constraint fk_model_product_general_tari_60 foreign key (general_tariff_id) references model_general_tariff (id);
create index ix_model_product_general_tari_60 on model_product (general_tariff_id);
alter table model_project add constraint fk_model_project_private_inst_61 foreign key (private_instance_blocko_instance_name) references model_homer_instance (blocko_instance_name);
create index ix_model_project_private_inst_61 on model_project (private_instance_blocko_instance_name);
alter table model_project add constraint fk_model_project_product_62 foreign key (product_id) references model_product (id);
create index ix_model_project_product_62 on model_project (product_id);
alter table model_project_participant add constraint fk_model_project_participant__63 foreign key (project_id) references model_project (id);
create index ix_model_project_participant__63 on model_project_participant (project_id);
alter table model_project_participant add constraint fk_model_project_participant__64 foreign key (person_id) references model_person (id);
create index ix_model_project_participant__64 on model_project_participant (person_id);
alter table model_type_of_block add constraint fk_model_type_of_block_projec_65 foreign key (project_id) references model_project (id);
create index ix_model_type_of_block_projec_65 on model_type_of_block (project_id);
alter table model_type_of_board add constraint fk_model_type_of_board_produc_66 foreign key (producer_id) references model_producer (id);
create index ix_model_type_of_board_produc_66 on model_type_of_board (producer_id);
alter table model_type_of_board add constraint fk_model_type_of_board_proces_67 foreign key (processor_id) references model_processor (id);
create index ix_model_type_of_board_proces_67 on model_type_of_board (processor_id);
alter table model_type_of_board add constraint fk_model_type_of_board_pictur_68 foreign key (picture_id) references model_file_record (id);
create index ix_model_type_of_board_pictur_68 on model_type_of_board (picture_id);
alter table model_type_of_widget add constraint fk_model_type_of_widget_proje_69 foreign key (project_id) references model_project (id);
create index ix_model_type_of_widget_proje_69 on model_type_of_widget (project_id);
alter table model_version_object add constraint fk_model_version_object_autho_70 foreign key (author_id) references model_person (id);
create index ix_model_version_object_autho_70 on model_version_object (author_id);
alter table model_version_object add constraint fk_model_version_object_libra_71 foreign key (library_id) references model_import_library (id);
create index ix_model_version_object_libra_71 on model_version_object (library_id);
alter table model_version_object add constraint fk_model_version_object_c_pro_72 foreign key (c_program_id) references model_cprogram (id);
create index ix_model_version_object_c_pro_72 on model_version_object (c_program_id);
alter table model_version_object add constraint fk_model_version_object_type__73 foreign key (type_of_board_id) references model_type_of_board (id);
create index ix_model_version_object_type__73 on model_version_object (type_of_board_id);
alter table model_version_object add constraint fk_model_version_object_b_pro_74 foreign key (b_program_id) references model_bprogram (id);
create index ix_model_version_object_b_pro_74 on model_version_object (b_program_id);
alter table model_version_object add constraint fk_model_version_object_m_pro_75 foreign key (m_program_id) references model_mprogram (id);
create index ix_model_version_object_m_pro_75 on model_version_object (m_program_id);
alter table post add constraint fk_post_postParentComment_76 foreign key (post_parent_comment_id) references post (id);
create index ix_post_postParentComment_76 on post (post_parent_comment_id);
alter table post add constraint fk_post_postParentAnswer_77 foreign key (post_parent_answer_id) references post (id);
create index ix_post_postParentAnswer_77 on post (post_parent_answer_id);
alter table post add constraint fk_post_type_78 foreign key (type_id) references type_of_post (id);
create index ix_post_type_78 on post (type_id);
alter table post add constraint fk_post_author_79 foreign key (author_id) references model_person (id);
create index ix_post_author_79 on post (author_id);
