...
alter table model_homer_instance add constraint fk_model_homer_instance_cloud_45 foreign key (cloud_homer_server_id) references model_homer_server (id);
create index ix_model_homer_instance_cloud_45 on model_homer_instance (cloud_homer_server_id);
