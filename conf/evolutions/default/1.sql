...
create table model_cprogram (
  ...
  constraint uq_model_cprogram_default_progra unique (default_program_type_of_board_id),
...
create table model_library_group (
  id                        varchar(255) not null,
  group_name                varchar(255),
  description               TEXT,
  product_id                bigint,
  azure_library_group_link  varchar(255),
  constraint pk_model_library_group primary key (id))
;
...
create table model_single_library (
  id                        varchar(255) not null,
  description               TEXT,
  library_name              varchar(255),
  product_id                bigint,
  azure_single_library_link varchar(255),
  constraint pk_model_single_library primary key (id))
;
...
create table model_version_object (
  ...
  constraint uq_model_version_object_default_ unique (default_version_program_id),
...
create table model_library_group_model_proces (
  model_library_group_id         varchar(255) not null,
  model_processor_id             varchar(255) not null,
  constraint pk_model_library_group_model_proces primary key (model_library_group_id, model_processor_id))
;
...
create table model_single_library_model_proce (
  model_single_library_id        varchar(255) not null,
  model_processor_id             varchar(255) not null,
  constraint pk_model_single_library_model_proce primary key (model_single_library_id, model_processor_id))
;
...
alter table model_cprogram add constraint fk_model_cprogram_first_defau_26 foreign key (first_default_version_object_id) references model_version_object (id);
...
alter table model_general_tariff_extensions add constraint fk_model_general_tariff_exten_37 foreign key (general_tariff_id) references model_general_tariff (id);
create index ix_model_general_tariff_exten_37 on model_general_tariff_extensions (general_tariff_id);
...
alter table model_general_tariff_label add constraint fk_model_general_tariff_label_39 foreign key (extensions_id) references model_general_tariff_extensions (id);
...
alter table model_library_group add constraint fk_model_library_group_produc_52 foreign key (product_id) references model_product (id);
create index ix_model_library_group_produc_52 on model_library_group (product_id);
...
alter table model_single_library add constraint fk_model_single_library_produ_66 foreign key (product_id) references model_product (id);
create index ix_model_single_library_produ_66 on model_single_library (product_id);
...
alter table model_version_object add constraint fk_model_version_object_libra_73 foreign key (library_group_id) references model_library_group (id);
create index ix_model_version_object_libra_73 on model_version_object (library_group_id);
alter table model_version_object add constraint fk_model_version_object_singl_74 foreign key (single_library_id) references model_single_library (id);
create index ix_model_version_object_singl_74 on model_version_object (single_library_id);
alter table model_version_object add constraint fk_model_version_object_c_pro_75 foreign key (c_program_id) references model_cprogram (id);
create index ix_model_version_object_c_pro_75 on model_version_object (c_program_id);
alter table model_version_object add constraint fk_model_version_object_defau_76 foreign key (default_version_program_id) references model_cprogram (id);
create index ix_model_version_object_defau_76 on model_version_object (default_version_program_id);
alter table model_version_object add constraint fk_model_version_object_b_pro_77 foreign key (b_program_id) references model_bprogram (id);
create index ix_model_version_object_b_pro_77 on model_version_object (b_program_id);
alter table model_version_object add constraint fk_model_version_object_m_pro_78 foreign key (m_program_id) references model_mprogram (id);
create index ix_model_version_object_m_pro_78 on model_version_object (m_program_id);
alter table post add constraint fk_post_postParentComment_79 foreign key (post_parent_comment_id) references post (id);
create index ix_post_postParentComment_79 on post (post_parent_comment_id);
alter table post add constraint fk_post_postParentAnswer_80 foreign key (post_parent_answer_id) references post (id);
create index ix_post_postParentAnswer_80 on post (post_parent_answer_id);
alter table post add constraint fk_post_type_81 foreign key (type_id) references type_of_post (id);
create index ix_post_type_81 on post (type_id);
alter table post add constraint fk_post_author_82 foreign key (author_id) references model_person (id);
create index ix_post_author_82 on post (author_id);
...
alter table model_library_group_model_proces add constraint fk_model_library_group_model__01 foreign key (model_library_group_id) references model_library_group (id);

alter table model_library_group_model_proces add constraint fk_model_library_group_model__02 foreign key (model_processor_id) references model_processor (id);
...
alter table model_single_library_model_proce add constraint fk_model_single_library_model_01 foreign key (model_single_library_id) references model_single_library (id);

alter table model_single_library_model_proce add constraint fk_model_single_library_model_02 foreign key (model_processor_id) references model_processor (id);
...
drop table if exists model_library_group cascade;

drop table if exists model_library_group_model_proces cascade;
...
drop table if exists model_single_library_model_proce cascade;
...
drop table if exists model_single_library cascade;
