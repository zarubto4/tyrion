...
alter table c_compilation add constraint fk_c_compilation_version_obje_16 foreign key (c_compilation_version) references version_object (id);
create index ix_c_compilation_version_obje_16 on c_compilation (c_compilation_version);
alter table c_program add constraint fk_c_program_project_17 foreign key (project_id) references project (id);
create index ix_c_program_project_17 on c_program (project_id);
alter table c_program add constraint fk_c_program_type_of_board_18 foreign key (type_of_board_id) references type_of_board (id);
create index ix_c_program_type_of_board_18 on c_program (type_of_board_id);
alter table file_record add constraint fk_file_record_version_object_19 foreign key (version_object_id) references version_object (id);
create index ix_file_record_version_object_19 on file_record (version_object_id);
alter table floating_person_token add constraint fk_floating_person_token_pers_20 foreign key (person_id) references person (id);
create index ix_floating_person_token_pers_20 on floating_person_token (person_id);
alter table homer add constraint fk_homer_project_21 foreign key (project_id) references project (id);
create index ix_homer_project_21 on homer (project_id);
alter table linked_post add constraint fk_linked_post_author_22 foreign key (author_id) references person (id);
create index ix_linked_post_author_22 on linked_post (author_id);
alter table linked_post add constraint fk_linked_post_answer_23 foreign key (answer_id) references post (id);
create index ix_linked_post_answer_23 on linked_post (answer_id);
alter table linked_post add constraint fk_linked_post_question_24 foreign key (question_id) references post (id);
create index ix_linked_post_question_24 on linked_post (question_id);
alter table m_program add constraint fk_m_program_m_project_25 foreign key (m_project_id) references m_project (id);
create index ix_m_program_m_project_25 on m_program (m_project_id);
alter table m_program add constraint fk_m_program_screen_size_type_26 foreign key (screen_size_type_id) references screen_size_type (id);
create index ix_m_program_screen_size_type_26 on m_program (screen_size_type_id);
alter table m_project add constraint fk_m_project_project_27 foreign key (project_id) references project (id);
create index ix_m_project_project_27 on m_project (project_id);
alter table m_project add constraint fk_m_project_b_program_28 foreign key (b_program_id) references b_program (id);
create index ix_m_project_b_program_28 on m_project (b_program_id);
alter table m_project add constraint fk_m_project_b_program_versio_29 foreign key (vrs_obj_id) references version_object (id);
create index ix_m_project_b_program_versio_29 on m_project (vrs_obj_id);
alter table notification add constraint fk_notification_person_30 foreign key (person_id) references person (id);
create index ix_notification_person_30 on notification (person_id);
alter table post add constraint fk_post_postParentComment_31 foreign key (post_parent_comment_id) references post (id);
create index ix_post_postParentComment_31 on post (post_parent_comment_id);
alter table post add constraint fk_post_postParentAnswer_32 foreign key (post_parent_answer_id) references post (id);
create index ix_post_postParentAnswer_32 on post (post_parent_answer_id);
alter table post add constraint fk_post_type_33 foreign key (type_id) references type_of_post (id);
create index ix_post_type_33 on post (type_id);
alter table post add constraint fk_post_author_34 foreign key (author_id) references person (id);
create index ix_post_author_34 on post (author_id);
alter table screen_size_type add constraint fk_screen_size_type_project_35 foreign key (project_id) references project (id);
create index ix_screen_size_type_project_35 on screen_size_type (project_id);
alter table type_of_block add constraint fk_type_of_block_project_36 foreign key (project_id) references project (id);
create index ix_type_of_block_project_36 on type_of_block (project_id);
alter table type_of_board add constraint fk_type_of_board_producer_37 foreign key (producer_id) references producer (id);
create index ix_type_of_board_producer_37 on type_of_board (producer_id);
alter table type_of_board add constraint fk_type_of_board_processor_38 foreign key (processor_id) references processor (id);
create index ix_type_of_board_processor_38 on type_of_board (processor_id);
alter table version_object add constraint fk_version_object_library_gro_39 foreign key (library_group_id) references library_group (id);
create index ix_version_object_library_gro_39 on version_object (library_group_id);
alter table version_object add constraint fk_version_object_single_libr_40 foreign key (single_library_id) references single_library (id);
create index ix_version_object_single_libr_40 on version_object (single_library_id);
alter table version_object add constraint fk_version_object_c_program_41 foreign key (c_program_id) references c_program (id);
create index ix_version_object_c_program_41 on version_object (c_program_id);
alter table version_object add constraint fk_version_object_b_program_42 foreign key (b_program_id) references b_program (id);
create index ix_version_object_b_program_42 on version_object (b_program_id);
